...
### _Circadian Phase Modulation of Cognitive Precision and Prediction Window Dynamics_
...
**Chain completeness:** Load-bearing. SCN control of cortisol, serotonin, dopamine, and noradrenergic rhythms is established across circadian neuroscience. The downstream MOD→COG consequences follow from [[contract_MOD_COG]].
