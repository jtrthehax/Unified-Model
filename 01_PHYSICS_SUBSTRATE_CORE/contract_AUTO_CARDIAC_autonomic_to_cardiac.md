...
- [[contract_SOC_AUTO_social_to_autonomic]] — co-regulation loss is the primary upstream mechanism for Takotsubo and vagal collapse
- [[contract_IMMUNE_AUTO_immune_to_autonomic]] — inflammatory tone sets the repolarization threshold floor
- [[contract_MET_IMMUNE_metabolic_to_immune]] — metabolic insolvency lowers the arrhythmia threshold through combined metabolic and immune channels
