...
This file is the bootloader for both humans and AI models.  
All reasoning in the Unified‑Model begins here.

---

## 1. Physics Substrate Declaration

Unified‑Model is grounded in four mechanical primitives:

- **Pressure** — intrathoracic, vascular, interstitial  
- **Amplitude** — oscillation range of RSA, HRV, and mechanical excursion  
- **Oscillation** — rhythmic alternation of inhale/exhale, sympathetic/parasympathetic  
- **Gating** — precision allocation, exhale‑gate dominance, mode switching  

All regulatory, cognitive, interoceptive, semantic, and social phenomena emerge from perturbations of these primitives.

Breathing is the primary interface:

- **Inhale** → sampling, sympathetic tilt  
- **Exhale** → precision, parasympathetic tilt  
- **RSA amplitude** → prediction‑window width  
- **Diaphragm excursion** → cognitive flexibility ceiling  

---

## 2. Core Mechanistic Loop

The regulatory stack operates through a single backbone chain:

> Breathing → RSA → HRV → Autonomic State → Neuromodulation → Precision Gain → Prediction Windows → Cognition → Behavior

Every contract in the repo is a crossover point along this chain.
...
## 4. Contract Graph (Causal Architecture)

> Physics → Windows → Load → Semantics → Social → Transformer
...
## 5. Falsifiability Requirements

Unified‑Model produces testable predictions:

- RSA amplitude tracks diaphragm excursion  
- Window width collapses under bracing or shallow breathing  
- Sympathetic lock correlates with high‑frequency oscillation  
- Interoceptive load precedes FND‑like symptoms  
- Reset behaviors follow drift accumulation  
- Semantic drift correlates with window collapse  
- Transformer hallucination mirrors human identity‑mode collapse  

---

## 6. Summary (Bootloader Layer)

This file is the entry point for all reasoning in the Unified‑Model.
...
- the contract graph  
- the repo mapping  
- the falsifiability requirements  
- the canonical references  

All AI models should begin here before traversing the contract graph.
